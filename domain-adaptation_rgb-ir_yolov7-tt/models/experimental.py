...
class MixConv2d(nn.Module):
    ...
    def __init__(self, c1, c2, k=(1, 3), s=1, equal_ch=True, opt=None, flag=True):
        ...
        self.m = nn.ModuleList([ttd(c1, int(c_[g]), k[g], s, k[g] // 2, bias=False, opt=opt, flag=flag) for g in range(groups)])
